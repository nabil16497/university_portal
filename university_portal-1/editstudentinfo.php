		...
		<form action="controller/updateStudent.php" method="POST" enctype="multipart/form-data">
			<table style="padding: 10px;">
				...
				<tr>
					...
					<td>
						<input value="<?php echo $student['firstname'] ?>" type="text" name="firstname"style="font-size: 15px;">
					</td>
					<td rowspan="11">

					<img src= <?php echo $student['image']; ?> alt="Profile Picture" style="max-height: 200px ; margin-bottom: 10px;"><br>
				...
				<tr>
					...
					<td>
						<input value="<?php echo $student['lastname'] ?>" type="text" name="lastname"style="font-size: 15px;">
					</td>
				...
				<tr>
					...
					<td>
						<input value="<?php echo $student['contact'] ?>" type="text" name="contact"style="font-size: 15px;">
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input value="<?php echo $student['email'] ?>" type="text" name="email"style="font-size: 15px;">
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input value="<?php echo $student['program'] ?>" type="text" name="program"style="font-size: 15px;">
					</td>
				</tr>
				<tr>
					<td>
